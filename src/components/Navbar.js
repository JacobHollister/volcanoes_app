                ...
                transition={transition()}>
                    <ul className="flex items-center font-medium" style={{width: "800px"}}>
                        ...
                        <li className="mr-2 ml-auto">
                            <button className="bg-transparent hover:bg-blue-500  font-medium text-blue-700 hover:text-white py-1 px-2 w-22 border border-blue-500 hover:border-transparent rounded h-8">
                                Register
                            </button>
                        </li>
                        <li className="mr-2">
                            <button className="bg-blue-500 hover:bg-blue-700 font-medium text-white py-1 px-4 rounded h-8 w-22">
                                Login
                            </button>
                        </li>
                </ul>
